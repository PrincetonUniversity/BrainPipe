...
if __name__ == '__main__':
    ...
    dest = 'Documents/python/data/20181001_zd_train/forward' #wanglab endpoint assumes default directory of /home/wanglab/
...
#            '20170204_tp_bl6_cri_1000r_02_1hfds_647_0010na_25msec_z7d5um_10povlap_ch00_z200-400_y1350-1700_x3100-3450']
    ...
    for dset in os.listdir(pth):
        ...
        predicted = probabiltymap_to_centers_thresh(impth, threshold = (0.4, 0.99))
        
        print '\n   Finished finding centers for {}, calculating statistics\n'.format(dset)
        
        ground_truth = points_dict[dset[:-20]+'.npy'] #modifying file names so they match with original data
        
        paired,tp,fp,fn = pairwise_distance_metrics(ground_truth, predicted, cutoff = 10) #returns true positive = tp; false positive = fp; false negative = fn
...
def probabiltymap_to_centers_thresh(src, threshold = (0.5, 0.99), numZSlicesPerSplit = 200, overlapping_planes = 40, cores = 4, return_pixels = False, verbose = True, structure_rank_order = 2):
    '''
    by tpisano
