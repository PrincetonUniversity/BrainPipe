...
from ClearMap.cluster.preprocessing import updateparams, arrayjob
from ClearMap.cluster.preprocessing import process_planes_completion_checker
import os
import sys
import shutil
...
# "##" = when taking a multi channel scan following regexpression, the
# channel corresponding to the reg/cell/inj channel.
