...
tif.imsave("/jukebox/LightSheetData/brodyatlas/atlas/for_registration_to_lightsheet/WHS_SD_rat_T2star_v1.01_atlas_for_pra_reg_ed.tif",
           watl_for_pra.astype("uint16"))

mv = "/jukebox/LightSheetData/brodyatlas/atlas/for_registration_to_lightsheet/WHS_SD_rat_T2star_v1.01_atlas_for_pra_reg_ed.tif"

out = "/jukebox/LightSheetData/brodyatlas/atlas/for_registration_to_lightsheet/waxholm_to_pra_ed"
