...
mvlist = ["WHS_SD_rat_atlas_v3_annotation","Chon-Paxinos-annotations","SIGMA_sagittal_ann"]
fxlist = ["m_matlas_alt","m_matlas_alt","m_matlas_alt"]
alignedlist =  ["WHS_SD_rat_T2star_v1.01_atlas","Chon-Allen-brain","SIGMA_sagittal_brain"]
