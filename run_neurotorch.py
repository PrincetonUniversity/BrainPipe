...
from neurotorch.datasets.dataset import TiffVolume, LargeTiffVolume, Volume
...
def main():
    ...
    inputs = TiffVolume('/home/wanglab/Documents/python/3dunet_data/neurotorch_training_data/train/raw/20170115_tp_bl6_lob6a_1000r_647_010na_z7d5um_125msec_10povlp_ch00_626-675_00_inputRawImages.tif')  # Create a volume containing inputs
    labels = TiffVolume('/home/wanglab/Documents/python/3dunet_data/neurotorch_training_data/train/label/20170115_tp_bl6_lob6a_1000r_647_010na_z7d5um_125msec_10povlp_ch00_626-675_00_inputLabelImages-segmentation.tif')  # Create a volume containing labels
