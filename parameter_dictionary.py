...
inputdictionary={
    "/jukebox/LightSheetData/lavision_testdata/4x_example/lavision_4x_cellch_z4um_10percentoverlap_demodataset": 
    [["cellch","00"]]
}
...
"outputdirectory": os.path.join(systemdirectory, "wang/ahoag/test_stitching_4um_brainpipe_forpub_newcode"),
"xyz_scale": (1.63,1.63,4.0), #micron/pixel x,y,z 
