...
systemdirectory=directorydeterminer() # root path of your filesystem, e.g. /home/username or /mnt/bucket if on a computing cluster
###set paths to data
...
inputdictionary={
    "/jukebox/LightSheetData/lavision_testdata/1.3x_example/lavision_1.3x_twochannels_z10um_demodataset/ch488": 
    [["regch","00"]],
    "/jukebox/LightSheetData/lavision_testdata/1.3x_example/lavision_1.3x_twochannels_z10um_demodataset/ch647": 
    [["cellch","00"]]
}
...
"outputdirectory": os.path.join(systemdirectory, "wang/ahoag/test_registration_brainpipe_forpub"),
"xyz_scale": (10.0,10.0,10.0), #micron/pixel x,y,z 
