...
template<class T> bool fastmarching_dt(T * inimg1d, float * &phi, int sz0,
                                       int sz1, int sz2, int cnn_type = 3, int bkg_thresh = 0) {
...
template<class T> bool fastmarching_dt_XY(T * inimg1d, float * &phi, int sz0,
        int sz1, int sz2, int cnn_type = 3, int bkg_thresh = 0) {
    enum {ALIVE = -1, TRIAL = 0, FAR = 1};
...
template<class T> bool fastmarching_dt_tree(T * inimg1d,
...
template<class T> bool fastmarching_dt_tree_XY(T * inimg1d,
        vector<MyMarker*> & outtree, int sz0, int sz1, int sz2, int cnn_type = 3,
        int bkg_thresh = 0) {
    enum {ALIVE = -1, TRIAL = 0, FAR = 1};
