...
#SBATCH -t 10
#SBATCH -o /scratch/ejdennis/logs/ts_import_%j.out        # STDOUT #add _%a to see each array job
#SBATCH -e /scratch/ejdennis/logs/ts_import_%j.err        # STDERR #add _%a to see each array job
