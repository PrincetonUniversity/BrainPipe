...
#SBATCH -t 40
#SBATCH -o /scratch/ejdennis/logs/ts_proj_%j.out        # STDOUT #add _%a to see each array job
#SBATCH -e /scratch/ejdennis/logs/ts_proj_%j.err        # STDERR #add _%a to see each array job
