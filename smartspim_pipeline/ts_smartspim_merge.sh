...
#SBATCH -t 800
#SBATCH -o /scratch/ejdennis/logs/ts_merge_%j.out        # STDOUT #add _%a to see each array job
#SBATCH -e /scratch/ejdennis/logs/ts_merge_%j.err        # STDERR #add _%a to see each array job
