...
OUT0=$(sbatch spim_register.sh 0 $1 $2 $3)
OUT1=$(sbatch --dependency=afternotok:${OUT0##* } spim_register_padded.sh 0 $1 $2 $3)
OUT2=$(sbatch --dependency=afternotok:${OUT1##* } spim_register_crop.sh 0 $1 $2 $3)
