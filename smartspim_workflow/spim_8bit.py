...
def dwnsz(pth,save_str,src):
    ...
    arrsagd=to_eight_bit_range(arrsag)
...
if __name__ == "__main__":
    ...
    print(os.path.join(os.path.dirname(dst), "{}_downsized_for_atlas.tif".format(savestr)))
    sixteenbit = tif.imread(os.path.join(os.path.dirname(dst), "{}_downsized_for_atlas.tif".format(savestr)))    
    eightbit=to_eight_bit_range(sixteenbit)
    tif.imsave(os.path.join(os.path.dirname(dst), "{}_downsized_for_atlas.tif".format(savestr)), eightbit.astype("uint8"))
