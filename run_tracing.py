...
inputdictionary={
os.path.join(systemdirectory, "LightSheetTransfer/brody/191029_w122_tetrode_1_1x_488_555_008na_1hfds_z10um_100msec_30povlp_13-37-10"): [["regch", "00"], ["cellch", "01"]]
}
...
"outputdirectory": os.path.join(systemdirectory, "LightSheetData/brodyatlas/testing/w122_30povlp"),
"xyz_scale": (5.91, 5.91, 10.0), #(5.0,5.0,3), #micron/pixel: 5.0um/pix for 1.3x; 1.63um/pix for 4x
"tiling_overlap": 0.30, #percent overlap taken during tiling
...
"annotationfile" : os.path.join(systemdirectory, "LightSheetTransfer/atlas/allen_atlas/annotation_2017_25um_sagittal_forDVscans.nrrd"), ###path to annotation file for structures
