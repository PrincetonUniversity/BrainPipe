...
inputdictionary = {
    os.path.join(systemdirectory, "LightSheetTransfer/brody/z269"):
    [["regch", "00"], ["cellch","01"]]
    # ,
...
params = {
    ...
    "outputdirectory": os.path.join(systemdirectory, "Desktop/brains/z269"),
    ...
    "AtlasFile": "home/emilyjanedennis/Desktop/for_registration_to_lightsheet/WHS_SD_rat_T2star_v1.01_atlas.tif",
    "annotationfile": "home/emilyjanedennis/Desktop/for_registration_to_lightsheet/WHS_SD_rat_atlas_v3_annoatation.tif",
