...
inputdictionary={
os.path.join(systemdirectory, "LightSheetTransfer/brody/191015_pbibawi_z269_ctbtracing_4x_555_647_017na_1hfds_z10um_150msec_20povlp_13-42-03"): [["cellch", "00"], ["cellch", "01"]]
}
...
"outputdirectory": os.path.join(systemdirectory, "LightSheetData/rat-brody/processed/201910_tracing/z269"),
"xyz_scale": (1.63, 1.63, 10.0), #(5.0,5.0,3), #micron/pixel: 5.0um/pix for 1.3x; 1.63um/pix for 4x
