...
inputdictionary={
os.path.join(systemdirectory, "LightSheetTransfer/tp/191206_v144_none_c4_1_4x_647_016na_1hfsds_z2um_150msec_10povlp_13-57-26"): 
    [["regch", "00"]]
}
...
"outputdirectory": os.path.join(systemdirectory, "LightSheetData/pni_viral_vector_core/imaris/v144_none_c4_1"),
"xyz_scale": (1.63, 1.63, 2.0), #(5.0,5.0,3), #micron/pixel: 5.0um/pix for 1.3x; 1.63um/pix for 4x
